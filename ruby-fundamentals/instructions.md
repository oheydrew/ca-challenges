Hi all. These are some problems that might help people nail down the concepts that we have covered so far. They are a good place to start testing out what you know from the course so far. They are not compulsory, but if you are finding the going tough then I'd suggest giving them a go. I would start with the challenges we give you during the day, but these are there for you to have a crack at outside of those class times.
...
If you find them difficult that's fine - they are starting point, and will help me to understand what it is that you don't understand. I am very happy to review any code relating to any problem in this list (although if you find them easy and are coping with Ruby then please keep my reviews of your code to 4 and 20 - I have limited time and you need to use your judgement).
...
https://gist.github.com/batteries76/e9d55141a83bc383b7f40466cc036946
...
allergies.list
=> ['peanuts', 'chocolate']
https://gist.github.com/batteries76/187978f424836a097932c8a1d4a853c9
...
https://gist.github.com/batteries76/bf0c6ab7aef6bd8ae5ef1147eff23216
*Problem 25*
*Balance*
...
https://gist.github.com/batteries76/11d1bdfd8bbd034f82bf00d9957d8a37